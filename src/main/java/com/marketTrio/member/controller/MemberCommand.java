...
public class MemberCommand implements Serializable {
	...
	public void setPassword(String password) { member.setPassword(password); }
	...
	public void setNickname(String nickname) { member.setNickname(nickname); }

	@Email(message = "이메일의 형식에 맞게 입력해야합니다")
	@NotBlank(message = "이메일은 필수 항목입니다")
	public String getEmail() { return member.getEmail(); }
	public void setEmail(String email) { member.setEmail(email); }

	@NotBlank(message = "번호는 필수 항목입니다")
	public String getPhone() { return member.getPhone(); }
	public void setPhone(String phone) { member.setPhone(phone); }

	@NotBlank(message = "아이디는 필수 항목입니다")
	public String getUserId() { return member.getId(); }
	public void setUserId(String userId) { member.setId(userId); }
}
