...
public class GBEntity implements Serializable {
	...
	public int getGBPostId() { return GBPostId; }
	public void setGBPostId(int gbPostId) { GBPostId = gbPostId; }
	...
	public void setRegularPrice(int d) { this.regularPrice = d; }
	...
	public List<GBParticipantEntity> getParticipants() { return participants; }
	public void setParticipants(List<GBParticipantEntity> participants) { this.participants = participants; }
	public List<String> getPictures() { return pictures; }
	public void setPictures(List<String> pictures) { this.pictures = pictures; }
	public int getGBStatus() { return GBStatus; }
	public void setGBStatus(int gBStatus) { GBStatus = gBStatus; }
}
